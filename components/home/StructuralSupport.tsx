            ...
            {[
               {
                  ...
                  title: "Technical GTM",
                  tags: ["Infra", "DePin"],
                  desc: "Full-stack launch playbooks tailored for technical protocol releases.",
               },
               {
                  icon: <Layers />,
                  title: "Narrative Design",
                  tags: ["Branding", "Story"],
                  desc: "Crafting durable positions within the decentralized zeitgeist.",
               },
               {
                  icon: <Activity />,
                  title: "Sprint Modules",
                  tags: ["Growth", "DAO"],
                  desc: "High-intensity 14-day growth sprints funded by vault yields.",
               },
            ].map((f, i) => (
               <div
                  key={i}
                  className="border-t border-black/10 pt-12 hover:border-[#4a6fa5] transition-colors group"
               >
                  <div className="p-4 bg-[#0a0a14] text-white w-fit mb-12 group-hover:bg-[#4a6fa5] transition-colors">
                     {f.icon}
                  </div>
                  ...
                  <div className="flex gap-2">
                     {f.tags.map((t) => (
                        <span
                           key={t}
                           className="text-[9px] font-bold uppercase tracking-widest text-[#8a8a93] border border-black/10 px-2 py-0.5 rounded-full"
                        >
                           {t}
                        </span>
                     ))}
