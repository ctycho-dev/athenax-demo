...
const FAQsData = [
   {
      ...
      answer:
         "Capital structuring, vault setup, 1:1 matching, tokenomics, GTM, media, and ongoing support.",
   },
   {
...
const AccordionItem = ({ question, answer }: AccordionItemProps) => {
   ...
   return (
      <div className="border-b last:border-0 border-gray-200 py-4">
         ...
         {isOpen && <div className="py-4 text-gray-600 leading-relaxed text-base">{answer}</div>}
      </div>
   );
};
