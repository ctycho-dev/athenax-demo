        ...
        {links.map((link) => (
          <div key={link.id} className="relative group">
            <button
              ...
              className={`text-sm font-semibold tracking-wide hover:text-blue-500 transition-colors pb-1 border-b-2 ${
                activePage.includes(link.id)
                  ? "border-black"
                  : "border-transparent"
              }`}
            >
    ...
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
      <div>
        ...
        <ul className="space-y-4">
          <li>
            <button
              onClick={() => setPage("ATHENA_TV_LIVESTREAM")}
          ...
          <li>
            <button
              onClick={() => setPage("ATHENA_TV_ROUNDTABLE")}
              className="hover:text-blue-400 transition-colors"
            >
              Roundtable
            </button>
          ...
          <li>
            <button
              onClick={() => setPage("ATHENA_TV_WHITEPAPER")}
              className="hover:text-blue-400 transition-colors"
            >
              Whitepaper Reading
            </button>
    ...
    <section className="py-24 px-6 bg-[#F5F5F7]">
      <div className="max-w-5xl mx-auto bg-white p-12 lg:p-20 border border-gray-200 rounded-2xl shadow-sm text-center">
        <p className="text-2xl md:text-3xl lg:text-4xl font-semibold leading-snug text-gray-900">
          "We grow ecosystems and incubate the projects building on top of them.
          AthenaX partners with L1s, L2s, and protocols to deliver builder
          onboarding, cross-chain growth, and narrative infrastructure."
        </p>
      </div>
    </section>
          ...
          {[
            {
              ...
              icon: <Users size={32} />,
              desc: "NounsDAO, Farcaster, subcommunities, IRL activation",
            },
            {
              title: "Narrative Layer",
              icon: <Radio size={32} />,
              desc: "Athena Live, Roundtable, Whitepaper Reading, Clips",
            },
            {
              title: "Builder Layer",
              icon: <Zap size={32} />,
              desc: "GTM, BD, token design, launch support, coaching",
            },
            {
              title: "BD Layer",
              icon: <Globe size={32} />,
              desc: "Multi-ecosystem BD, partnerships, builder migration",
            },
          ].map((item, i) => (
            <div
              key={i}
          ...
          <div className="aspect-video bg-gray-800 rounded-xl mb-6 relative overflow-hidden group cursor-pointer border border-gray-700">
            ...
            <div className="absolute bottom-0 left-0 w-full p-8 bg-gradient-to-t from-black/80 to-transparent">
              <h4 className="text-2xl font-bold">
                Incubating the Next Wave of Farcaster Builders
              </h4>
            </div>
          </div>
          ...
          <div className="space-y-6 flex-grow">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex gap-4 group cursor-pointer">
                ...
                <div>
                  <h4 className="font-bold text-sm line-clamp-2 group-hover:text-blue-400 transition-colors">
                    Why Ecosystems Fail: A Deep Dive into L2 GTM
                  </h4>
...
const ForProjectsPage = () => (
  <main>
    <section className="py-24 px-6 bg-[#F5F5F7] min-h-[70vh] flex items-center relative overflow-hidden">
      <div className="absolute top-0 right-0 w-1/3 h-full opacity-5 pointer-events-none select-none text-[600px] font-bold">
        X
      </div>
      <div className="max-w-4xl relative z-10 mx-auto text-center">
        ...
        <p className="text-2xl text-gray-600 mb-10 max-w-2xl mx-auto">
          ...
          through our unique incubation infrastructure.
        </p>
          ...
          {[
            {
              title: "Grant Support",
              icon: <CheckCircle2 />,
              desc: "NounsDAO + Octant funding access",
            },
            {
              title: "Vault Matching",
              icon: <CheckCircle2 />,
              desc: "1:1 capital match on deposits",
            },
            {
              title: "Sprint Campaigns",
              icon: <CheckCircle2 />,
              desc: "7–30 day growth modules",
            },
            {
              title: "GTM Strategy",
              icon: <CheckCircle2 />,
              desc: "Launch playbooks and coaching",
            },
            {
              title: "Tokenomics",
              icon: <CheckCircle2 />,
              desc: "Expert design guidance",
            },
            {
              title: "Narrative Design",
              icon: <CheckCircle2 />,
              desc: "Positioning and storytelling",
            },
            {
              title: "Media Amplification",
              icon: <CheckCircle2 />,
              desc: "6M+ cross-chain monthly reach",
            },
            {
              title: "BD & Partnerships",
              icon: <CheckCircle2 />,
              desc: "Multi-ecosystem introductions",
            },
          ].map((item, i) => (
            <div
              key={i}
              className="p-8 border rounded-xl hover:border-blue-400 transition-all shadow-sm"
            >
    ...
    <section className="py-24 px-6 bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 relative">
          ...
          {[
            ...
            >
              ...
              <p className="font-bold text-center text-sm uppercase tracking-wider">
                {item.label}
              </p>
            </div>
          ))}
        ...
        <p className="mt-16 text-center text-gray-500 italic">
          "AthenaX never touches principal. Only yield is used to fund your
          growth."
        </p>
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-[#F5F5F7] p-10 rounded-2xl border">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-6 pt-2">
                <label className="flex items-center gap-2 font-bold">
                  <input type="radio" name="stage" /> Pre-launch
                </label>
                <label className="flex items-center gap-2 font-bold">
                  <input type="radio" name="stage" /> Launched
                </label>
              </div>
            </div>
          </div>
          <div className="space-y-2 mb-8">
            ...
            <textarea
              className="w-full p-4 border rounded-lg h-32 outline-none"
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white p-8 rounded-2xl border shadow-sm">
          <AccordionItem
            ...
            answer="GTM, narrative design, sprint campaigns, tokenomics guidance, vault setup, grant navigation, BD, and media amplification."
          />
          <AccordionItem
            question="Do we need funding before applying?"
            answer="No. We help you secure grants from NounsDAO and Octant to kickstart your project."
          />
          <AccordionItem
            question="Do we need to deploy capital?"
            answer="Yes. All projects deposit into an Octant vault. AthenaX matches this deposit 1:1."
          />
          <AccordionItem
            question="Can vault yield fund sprints?"
            answer="Yes. The yield generated by the matched vault can be used to fund high-impact sprint campaigns."
          />
        </div>
      </div>
    </section>
...
const ForEcosystemsPage = () => (
  <main>
    <section
      className={`py-24 px-6 bg-[#020617] text-white min-h-[60vh] flex items-center`}
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        <p className="text-2xl text-gray-400 mb-10 max-w-2xl">
          ...
          Full-stack growth infrastructure for L1s, L2s, and protocols.
        </p>
        <Button variant="blue" className="px-12 py-5 text-lg">
          Let's Talk →
        </Button>
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20">
        <div>
          ...
          <ul className="space-y-6">
            {[
              "Inconsistent builder onboarding",
              "Fragmented growth efforts",
              "Weak feedback loops between grants and traction",
              "No shared narrative layer",
              "Low developer stickiness",
            ].map((item, i) => (
              <li
                key={i}
                className="flex gap-4 text-xl font-medium text-gray-700"
              >
        ...
        <div>
          ...
          <p className="text-2xl leading-relaxed text-gray-600 mb-8">
            "AthenaX operates as your embedded ecosystem incubation partner. Not
            an agency. Full-stack growth infrastructure that aligns capital,
            narrative, and distribution into a single loop."
          </p>
          <div className="p-8 bg-white rounded-xl border border-gray-200">
            <h4 className="font-bold mb-4 uppercase tracking-widest text-xs text-blue-600">
              The Outcome
            </h4>
            <p className="text-lg font-bold">
              Sustainable, yield-funded growth that keeps principal treasury
              assets untouched while compounding builder activity.
            </p>
          </div>
        </div>
      </div>
    ...
    <section className="py-24 px-6 bg-[#F5F5F7] border-y">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          {["Octant", "Polkadot", "Magic Eden", "Neura Protocol", "Mantle"].map(
            (name, i) => (
              <div
                key={i}
                className="bg-white p-8 rounded-xl border flex flex-col items-center justify-center gap-4"
              >
  ...
  <main className="bg-white">
    <section className="py-20 px-6 max-w-7xl mx-auto">
      ...
      <p className="text-xl text-gray-500 mb-12">
        Latest Posts, News, and Community Announcements
      </p>
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-12 items-center justify-between">
        ...
        <div className="relative w-full md:w-96">
          ...
          />
          <input
            className="w-full pl-12 pr-4 py-3 border rounded-full bg-gray-50"
      ...
      <div className="grid md:grid-cols-3 gap-10">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div
            ...
            onClick={() => setPage("BLOG_ARTICLE")}
          >
            <div className="aspect-video bg-gray-100 rounded-2xl mb-6 overflow-hidden relative">
              <span className="absolute top-4 left-4 px-3 py-1 bg-white/90 backdrop-blur text-[10px] font-bold uppercase rounded-full">
                Announcements
              </span>
            ...
            <h4 className="text-2xl font-bold mb-3 group-hover:text-blue-600 transition-colors">
              How AthenaX is Revolutionizing Ecosystem Growth with NounsDAO
            </h4>
      ...
      <div className="mt-20 flex justify-center">
        <Button variant="secondary" className="rounded-full px-12">
          Load More
        </Button>
      </div>
    </section>
...
const AthenaTVPage = ({ type = "HUB", setPage }: AthenaTVPageProps) => {
  const shows = [
    {
      id: "ATHENA_TV_LIVESTREAM",
      title: "Livestream",
      freq: "5×/week",
      desc: "Daily founder conversations",
    },
    {
      id: "ATHENA_TV_ROUNDTABLE",
      title: "Roundtable",
      freq: "2×/month",
      desc: "Deep-dive episodes",
    },
    {
      id: "ATHENA_TV_WHITEPAPER",
      title: "Whitepaper Reading",
      freq: "20×/month",
      desc: "Technical explainers",
    },
  ];
    ...
    <main className="bg-[#020617] text-white min-h-screen">
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <h1 className="text-6xl md:text-8xl font-bold mb-6">
          Athena.<span className="italic text-blue-500">TV</span>
        </h1>
        <p className="text-2xl text-gray-400">
          Founder-focused programming across chains.
        </p>
      </section>
            ...
            <div className="aspect-video bg-gray-900 rounded-2xl border border-white/10 mb-8 overflow-hidden group cursor-pointer">
              <div className="w-full h-full flex items-center justify-center bg-gray-800">
                <Play
                  size={64}
                  fill="white"
                  className="opacity-50 group-hover:opacity-100 group-hover:scale-110 transition-all"
                />
              </div>
            </div>
            <h2 className="text-3xl font-bold mb-4">
              Roundtable #42: The Future of Modular Liquidity
            </h2>
            <div className="flex gap-4 items-center">
              <span className="px-3 py-1 bg-blue-600 text-[10px] font-bold uppercase rounded">
                Newest Release
              </span>
              <span className="text-gray-500 font-bold text-xs">
                OCT 28, 2025 • 1HR 12MIN
              </span>
            </div>
          </div>

          <div className="flex flex-col gap-6">
            <h4 className="font-bold text-lg uppercase tracking-widest text-gray-500">
              Recent Episodes
            </h4>
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex gap-4 group cursor-pointer">
                ...
                <div>
                  <h5 className="font-bold text-sm leading-snug group-hover:text-blue-500 transition-colors">
                    Building the Consumer Layer on TON
                  </h5>
                  <p className="text-[10px] text-gray-500 mt-1 uppercase">
                    LIVESTREAM • 4 DAYS AGO
                  </p>
                </div>
              </div>
            ))}
        ...
        <div className="flex justify-between items-center mb-12">
          ...
          <div className="flex gap-2">
            {["All", "Livestream", "Roundtable", "Technical"].map((t) => (
              <button
                key={t}
                className="px-4 py-2 bg-white/5 border border-white/10 rounded-full text-xs font-bold hover:bg-white/10"
              >
                {t}
              </button>
            ))}
          ...
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="group cursor-pointer">
              <div className="aspect-video bg-gray-800 rounded-xl mb-4 overflow-hidden relative">
                <span className="absolute bottom-2 right-2 px-2 py-1 bg-black/80 text-[10px] font-bold rounded">
                  24:12
                </span>
              </div>
              <h4 className="text-xl font-bold group-hover:text-blue-500 transition-colors">
                Whitepaper Reading: Monad's Parallel Execution Pipeline
              </h4>
              <p className="text-sm text-gray-500 mt-2">
                TECHNICAL • OCT 12, 2025
              </p>
            </div>
          ))}
        </div>
...
const AboutPage = () => (
  <main className="bg-white">
    <section className="py-32 px-6 bg-[#F5F5F7] text-center border-b">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-7xl font-bold mb-12 tracking-tighter">
          About AthenaX
        </h1>
        <p className="text-3xl md:text-4xl font-semibold text-gray-900 leading-tight">
          "Our mission is to build a regenerative digital economy that creates
          conditions of prosperity for all."
        </p>
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20">
        <div>
          ...
          <div className="space-y-6 text-xl text-gray-600 leading-relaxed">
            <p>
              AthenaX is a decentralized ecosystem incubator powered by
              NounsDAO. We work at the ecosystem layer — helping chains grow,
              founders succeed, and communities scale across the multi-chain
              landscape.
            </p>
            <p>
              We operate inside NounsDAO, accessing 600+ subcommunities and
              56,000+ ecosystem members. When you partner with AthenaX, you're
              plugging into one of the largest grassroots networks in Ethereum.
            </p>
          </div>
        </div>
        <div className="space-y-8">
          {[
            {
              title: "NounsDAO",
              desc: "Cultural gravity, CC0 ethos, 56,000+ members. 33rd largest ETH holder.",
            },
            {
              title: "Octant / Golem",
              desc: "$2M+ distributed. 100,000+ ETH staked. 8th largest ETH holder.",
            },
            {
              title: "AthenaX Media",
              desc: "6M+ monthly reach. Multi-chain distribution through founder-focused media.",
            },
          ].map((card, i) => (
            <div
              key={i}
  ...
  <main className="bg-white">
    <section className="py-24 px-6 max-w-7xl mx-auto">
      ...
      <p className="text-2xl text-gray-500 mb-12">
        Chains, DAOs, and projects connected through AthenaX
      </p>
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-start">
        <div className="w-full lg:w-64 space-y-8 shrink-0">
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {["All", "AI", "DeFi", "Infra", "L1", "L2", "Gaming"].map(
                (cat) => (
                  <button
                    key={cat}
        ...
        <div className="flex-grow grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((i) => (
            <div
              key={i}
              className="p-8 border rounded-2xl hover:border-blue-500 transition-all cursor-pointer group"
            >
              ...
              <p className="text-gray-500 text-sm mb-6 line-clamp-2">
                Building high-performance liquidity layers for the next wave of
                cross-chain DeFi.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="text-[9px] font-bold px-2 py-1 bg-gray-100 rounded uppercase">
                  DeFi
                </span>
                <span className="text-[9px] font-bold px-2 py-1 bg-blue-50 text-blue-600 rounded uppercase">
                  INCUBATED
                </span>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            {
              title: "HackX",
              desc: "Builder-focused hackathon infrastructure sourcing projects into incubation pipeline.",
            },
            {
              title: "Nouns × Mantle",
              desc: "L2 builder onboarding through NounsDAO cultural reach.",
            },
            {
              title: "Polkadot DV",
              desc: "Decentralized Voice governance participation and technical voting architecture.",
            },
            {
              title: "Nouns × Magic Eden",
              desc: "Creator and IP activation partnership leveraging NFT distribution.",
            },
          ].map((cs, i) => (
            <div
              key={i}
...
const BlogArticlePage = ({ setPage }: PageProps) => (
  <main className="bg-white">
    <div className="max-w-4xl mx-auto px-6 py-20">
      <button
        onClick={() => setPage("BLOG")}
        className="flex items-center gap-2 font-bold text-gray-400 hover:text-black mb-12 uppercase tracking-widest text-xs"
      >
      ...
      <h1 className="text-5xl font-bold mb-6 leading-tight">
        The AthenaX Thesis: Why Incubation is the Next Stage of DAO Evolution
      </h1>
      ...
      <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-8">
        <p className="text-2xl font-semibold text-gray-900">
          AthenaX is more than a fund. It is an infrastructure layer for growth.
          In this article, we break down our vision for the multi-chain future.
        </p>
        <h2 className="text-3xl font-bold text-gray-900 pt-8">
          The Problem with Traditional Grants
        </h2>
        <p>
          Most grants programs suffer from a "spray and pray" mentality. Capital
          is distributed, but support is minimal. There are no feedback loops
          between initial funding and market traction. This leads to high churn
          and wasted resources for the ecosystem treasury.
        </p>
        <blockquote className="border-l-4 border-blue-600 pl-8 py-4 bg-blue-50/30 text-2xl italic font-medium">
          "The next billion users won't just need a wallet; they'll need
          ecosystems that offer complete infrastructure, narrative, and
          community alignment from day one."
        </blockquote>
        <h3 className="text-2xl font-bold text-gray-900">
          A New Model: Yield-Funded Growth
        </h3>
        <p>
          By leveraging the Octant vault model, we ensure that principal capital
          remains protected. We use yield to fund high-impact growth
          modules—what we call "Sprint Campaigns"—that target specific KPIs like
          user acquisition, protocol launch, or technical stability.
        </p>
      </article>
...
export default function V2() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case "FOR_PROJECTS":
        return <ForProjectsPage />;
      case "FOR_ECOSYSTEMS":
        return <ForEcosystemsPage />;
      case "ATHENA_TV":
        return <AthenaTVPage setPage={setCurrentPage} />;
      case "ATHENA_TV_LIVESTREAM":
        return <AthenaTVPage type="LIVESTREAM" setPage={setCurrentPage} />;
      case "ATHENA_TV_ROUNDTABLE":
        return <AthenaTVPage type="ROUNDTABLE" setPage={setCurrentPage} />;
      case "ATHENA_TV_WHITEPAPER":
        return <AthenaTVPage type="WHITEPAPER" setPage={setCurrentPage} />;
      case "ABOUT":
        return <AboutPage />;
      case "BLOG":
        return <BlogPage setPage={setCurrentPage} />;
      case "BLOG_ARTICLE":
        return <BlogArticlePage setPage={setCurrentPage} />;
      case "ECOSYSTEM":
        return <EcosystemDirectoryPage />;
      default:
        return <HomePage setPage={setCurrentPage} />;
    }
  };
  ...
  return (
    <div
      className={`min-h-screen font-sans selection:bg-blue-200 selection:text-blue-900`}
