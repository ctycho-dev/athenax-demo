        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="space-y-4 text-xs font-bold uppercase tracking-widest">
                ...
                <div className="flex gap-4">
                    <FaXTwitter size={16} className="hover:text-white cursor-pointer" />
        ...
        switch (activePage) {
            ...
            case 'blog-article':
                return selectedArticle ? (
                    <ArticleView article={selectedArticle} onBack={handleBackToBlog} />
                ) : (
                    <BlogPage onSelectArticle={handleArticleSelect} />
                );
