...
const Button = ({
  ...
  const variants = {
    primary:
      "bg-[#020617] text-white hover:bg-[#111827] disabled:opacity-50 disabled:cursor-not-allowed",
    secondary:
      "bg-transparent border-2 border-[#020617] text-[#020617] hover:bg-[#020617] hover:text-white disabled:opacity-50 disabled:cursor-not-allowed",
