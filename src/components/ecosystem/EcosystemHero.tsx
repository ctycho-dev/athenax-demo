...
export const EcosystemHero = () => (
  <section className="py-24 px-6 bg-[#020617] text-white min-h-[60vh] flex items-center">
    <div className="max-w-7xl mx-auto w-full">
      ...
      <Link
        to="mailto:athena@athenax.co"
        className="px-6 py-3 font-semibold uppercase tracking-wider text-sm transition-all duration-200 flex items-center justify-center gap-2 bg-[#2F80FF] text-white hover:bg-[#2563EB] w-fit"
      >
        Let's Talk →
      </Link>
    </div>
