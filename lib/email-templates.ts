...
<body>
  ...
  <div class="content">
    <p>Hi there,</p>
    <p>Thank you for applying to the <strong>AthenaX Network</strong>! We've received your application and our team will review it shortly.</p>
    ...
    <div class="info-box">
      ...
      <div class="info-row">
        <span class="label">Your Pitch:</span>
        <span class="value" style="white-space: pre-wrap;">${data.pitch}</span>
      </div>
    </div>

    <div style="margin: 20px 0; padding: 15px; background: #eff6ff; border-left: 4px solid #1d4ed8; border-radius: 4px;">
      <p style="margin: 0; color: #1e40af; font-size: 14px;">
        <strong>What's Next?</strong><br>
        Our team reviews applications regularly. We'll get back to you within 3-5 business days if we think there's a good fit.
      </p>
    </div>
...
export function generateAdminNotificationEmail(data: ApplicationFormData): {
   ...
   const subject = `New Application: ${data.projectName}`;
...
<body>
  ...
  <div class="content">
    <p style="font-size: 16px; color: #111827; margin-top: 0;">
      A new project has applied to join the AthenaX Network.
    </p>
